-- VITA v4.1.2
-- SQL defensivo para estructura antigua/nueva de listas.
-- Corrige: shopping_lists_list_type_check.
...
-- Listas: soporta el esquema antiguo (visibility/name/list_type) y el nuevo (title/active).
...
-- Eliminar checks antiguos que bloqueaban 'shared' o valores nuevos.
